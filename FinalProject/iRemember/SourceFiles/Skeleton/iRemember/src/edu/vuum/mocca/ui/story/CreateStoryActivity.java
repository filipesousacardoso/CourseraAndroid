...
public class CreateStoryActivity extends StoryActivityBase {
	...
	private void launchCameraIntent() {
		...
		Intent camActivity = new Intent(android.provider.MediaStore.ACTION_IMAGE_CAPTURE);
		...
		camActivity.putExtra(MediaStore.EXTRA_OUTPUT,fragment.imagePath);
		
		// TODO - Start a new activity for result, using the new intent and the request
		// code CAMERA_PIC_REQUEST
		startActivityForResult(camActivity, CAMERA_PIC_REQUEST);
	...
	private void launchVideoCameraIntent() {
		...
		// Hint: use standard Intent from MediaStore class
		// See: http://developer.android.com/reference/android/provider/MediaStore.html
		Intent vidActivity = new Intent(android.provider.MediaStore.ACTION_VIDEO_CAPTURE);
		...
		File vid=getOutputMediaFile(MEDIA_TYPE_VIDEO);

		// TODO - Add the filename to the Intent as an extra. Use the Intent-extra name
		// from the MediaStore class, EXTRA_OUTPUT
		vidActivity.putExtra(MediaStore.EXTRA_OUTPUT, vid);
		...
		vidActivity.putExtra(MediaStore.EXTRA_VIDEO_QUALITY, 1);

		
		// TODO - Start a new activity for result, using the new intent and the request
		// code CAMERA_VIDEO_REQUEST
		startActivityForResult(vidActivity, CAMERA_VIDEO_REQUEST);
